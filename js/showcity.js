...
export class ShowCity {
    ...
    setCityChart (cityname1, scores1){
        const chartHtml = `<h1 class="chart-title">Rating life</h1>
       <canvas id="cityChart" width="500" height="500"></canvas><div class="compare-box"></div>`;
